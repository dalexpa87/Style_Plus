...
<body class="grey lighten-1 center" >  

      <div class="container col s12 l8 m9 ">
      ...
      <form class="col s12 center" action="../controller/usuarios.controller.php" method="POST">
        ...
        <div class="row center" >
          ...
          <div class="input-field col s10 l5 m5 black-text ">
            <label class="white-text">Número de documento</label>
            <br>
      ...
      <div class="row" >
          <div class="input-field col s10 l5 m5 black-text" >
            <label class="white-text">Nombres</label>
            <br>
            <input type="text" name="nombre" class="validate" required/ >
          </div>
          <div class="input-field col s10 l5 m5 black-text">
            <label class="white-text">Apellidos</label>
            <br>
      ...
      <div class="row" >
          <div class="input-field col s10 l5 m5 black-text">
            <label class="white-text">Número celular</label>
            <br>
            <input type="text" name="celular" class="validate" required/>
          </div> 

          <div class="input-field col s10 l5 m5 black-text">
            <label class="white-text">Número de telefono</label>
            <br>
      ...
      <div class="row" >
          ...
          <div class="input-field col s10 l5 m5 black-text">
            <label class="white-text">Ciudad</label>
            <br>
      ...
      <div class="row" >
          ...
          <div class="input-field col s10 l5 m5 black-text">
            <label class="white-text">Asigne una  contraseña</label>
            <br>
      ...
      <button type="button" class="waves-effect black btn"><a href="index.php" class="white-text" >cancelar</a></button>
